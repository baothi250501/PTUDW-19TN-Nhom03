...
function handleFooter() {
    ...
    let span2 = creElem('span','', [document.createTextNode('+84945335984')]);
    ...
    let span4 = creElem('span','', [document.createTextNode('coco123@gmail.com')]);
    ...
    let hr = creElem('hr','',[]);
    hr.setAttribute('style','border: 2px solid white;background-color: white; width: 98%');
